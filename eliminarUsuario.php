...
<table class="table table-hover table-bordered table-dark">
    <?php
        ...
        $sql = mysqli_query($cn, "SELECT * from usuario where idStatus = 1");


        while ($usuariosActivos = mysqli_fetch_array($sql)) {
            
            echo "<tr class='text-center'><td>" . $usuariosActivos['usuario'] . "</td><td><a href='./php/eliminarUsuario.php?idUsuario=". $usuariosActivos['idUsuario']."' class='btn btn-danger'>Eliminar</a></td></tr>"; 
